// afk-core/src/profile/elementalmc/antiAfk.js
"use strict";

// ElementalMC anti-AFK-kick — a small periodic head turn (bot.look(), the correct
...
function nudge(botId, entry, bot) {
  ...
  try {
    ...
    console.log(
      `[ElementalMcProfile] 👀 [${entry.minecraftUser}] Anti-AFK nudge ` +
    ...
    console.warn(`[ElementalMcProfile] ⚠️ [${entry.minecraftUser}] Anti-AFK look failed:`, err.message);
