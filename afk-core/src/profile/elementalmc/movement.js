// afk-core/src/profile/elementalmc/movement.js
"use strict";

// ElementalMC per-tick movement keepalive (anti-detection). ElementalMC's survival
  ...
  let timer = setInterval(() => {
    ...
    try {
      ...
      if (!warned) {
        warned = true;
        console.warn(
          `[ElementalMcProfile] ⚠️ [${entry.minecraftUser}] per-tick flying failed:`,
          err.message
        );
      }
    }
